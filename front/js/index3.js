...
async function mayorPuntaje() {
        ...
        let record = respuesta 
        return record
        
    }
    
async function actualizarRecordSiEsMayor(puntaje) {
    let recordActual = await mayorPuntaje();
    ...
    if (puntaje > recordActual) {
        ...
        document.getElementById("record1").innerText = puntaje;
    } else {
        document.getElementById("record1").innerText = recordActual;
    }

    document.getElementById("puntaje1").innerText = puntaje;
}
>>>>>>> Stashed changes
